...
public class Temperature {
    ...
    public static void deleteOutput() throws IOException{
        ...
        String hdfsOutput = "hdfs://192.168.1.61:8020/output";
    ...
    public static void main(String[] args) throws Exception {
        deleteOutput();
        //输入路径
        String dst = "hdfs://192.168.1.61:8020/user/hadoop/input.txt";
        //输出路径，必须是不存在的，空文件加也不行。
        String dstOut = "hdfs://192.168.1.61:8020/output";
        ...
        Job job = Job.getInstance(hadoopConfig,"test");
